...
<model-viewer src="Models/DodgerDance_49sec.glb?sound=Sound/AB Dodger 2022.mp3" camera-controls camera-orbit="0deg 90deg 65%" autoplay animation-name="" id="reveal" id="model-viewer" loading="eager" ar ar-modes="scene-viewer webxr quick-look" ios-src="Models/DodgerDance_49sec.reality" alt="Dodgers AB" auto-rotate-delay="0" ar-scale="auto" camera-controls alt="Dancing Dodger Character" style="width: 95%; height: 750px" ><button slot="ar-button" style="background-color: white; border-radius: 8px; border: 1 px solid black; position: absolute; top: 20px; right: 20px; ">
      👋 AR Click Here
  </button>
</model-viewer>
